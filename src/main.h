...
static const int64 MAX_MINT_PROOF_OF_WORK = 1600 * COIN;
...
static const uint256 hashGenesisBlockOfficial("0x00000051d565d8f5d836be5aca33610d6a42d41dbf36a4873a223b0952a563e7");
static const uint256 hashGenesisBlockTestNet("0x00000051d565d8f5d836be5aca33610d6a42d41dbf36a4873a223b0952a563e7");
...
extern CBigNum nBestInvalidTrust;
...
// Milancoin: calculate Nfactor using timestamp
...
public:
    ...
    {
        // milancoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // milancoin: get transaction coin age
...
public:
    ...
    // milancoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // milancoin: entropy bit for stake modifier if chosen by modifier
    unsigned int GetStakeEntropyBit(unsigned int nHeight) const
    {
        // Protocol switch to support p2pool at Milancoin block #9689
//        if (nHeight >= 9689)
        {
...
/*        // Before Milancoin block #9689 - old protocol
...
// DIFF: protocol switch not needed as soon as newer version can be used
    ...
    // milancoin: two types of block: proof-of-work or proof-of-stake
    ...
    // milancoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // milancoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // milancoin: trust score of block chain
    int nHeight;

    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // milancoin: block index flags
    enum  
    {
