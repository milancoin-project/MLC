...
void MiningPage::minerError(QProcess::ProcessError error)
{
    ...
    {
        reportToList(tr("Miner failed to start. Make sure you have the minerd executable and libraries in the same directory as MilanCoin-Qt."), ERROR, NULL);
    }
}
...
{
    if (index == 0){  // pool.milancoin.com
        ui->portLine->setText("8667");
    }
    else {//others
        ui->portLine->setText("");
    }
